...
inputPath = "O:/Apollo_11_30-Track/concatenated_wav_files/defluttered/"
workingPath = "F:/A11_MOCR_transcription/"
    ...
    for dir in dirs:
        for file in os.listdir(os.path.join(root, dir)):
            if (
                ...
                outputPath = os.path.join(workingPath, dir, file, "wavs")
