...
inputFilePath = "../_website/_webroot/MOCRviz/data/tape_ranges.csv"
...
for idx, val in enumerate(HR1_tape_ranges):
    try:
        ...
        tapeActivityJSONPath = ('F:/mp3/' + val[0] + '_defluttered_mp3_16/' + val[0] + '_defluttered_mp3_16noiseranges.json')
