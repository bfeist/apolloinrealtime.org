...
export function MocrvizAbout({ mission, hidden }: { mission: MocrMissionId; hidden: boolean }) {
  ...
  return (
    <div className={styles.mocrvizTranscriptAbout} data-testid="mocr-about" hidden={hidden}>
      <div className={styles.title} data-testid="mocr-about-title">
      ...
      <div className={styles.subtitle}>Digitization</div>
      <div className={styles.copy}>
        <p>
      ...
      <div className={styles.mocrvizAboutImages} data-testid="mocr-about-images">
      ...
      <div className={styles.title}>About These Mission Control Transcripts</div>
      <div className={styles.copy}>
        <p>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className={styles.openAiLink}
            aria-label="OpenAI Whisper"
          >
            <svg className={styles.openAiLogo} viewBox="0 0 936 232" role="img" aria-label="OpenAI">
        ...
        <p>
          ...
          <span className={styles.highlighted}>{copy.hours} hours</span> of Mission Control audio
          required over <span className={styles.highlighted}>{copy.processingHours} hours</span> of
          computer time. The resulting transcripts contain{" "}
          <span className={styles.highlighted}>{copy.utterances} utterances</span>, consisting of{" "}
          <span className={styles.highlighted}>{copy.words} words</span>, totaling{" "}
          <span className={styles.highlighted}>{copy.size} of text</span>. Download the transcripts
          for all mission control channels in a single file{" "}
          <a
      ...
      <div className={styles.subtitle}>Accuracy and Timing</div>
      <div className={styles.copy}>
