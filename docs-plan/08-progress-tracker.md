...
**2026-09-05: navigator timeline-label fidelity correction complete and verified. No production cutover.** Restored the legacy half-hour tick geometry: ticks alone in tier 2; bottom-anchored, -90-degree labels in tier 3; and a playback time label centered on its cursor rather than edge-clamped. A visible desktop comparison used Apollo 13 at `000:00:00`; the typed header has aligned cursor text and vertical detailed-tier labels. The focused 1440/768/390 recovery run passed for Apollo 11, 13, and 17. `npm run check` passes 272 tests and `npm run build` passes. No snapshots were updated. Continue the remaining release audit below; use direct production comparisons, including component states. Screenshot captures generated by tests stay out of version control; previously accepted typed screenshots preserve mistakes and are not evidence of production fidelity. Read this file, `05-migration-plan.md`, then `README.md`.
